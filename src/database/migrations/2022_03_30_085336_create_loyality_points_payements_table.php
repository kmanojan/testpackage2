...
class CreateLoyalityPointsPayementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acc_loyalty_points_payments', function (Blueprint $table) {
            // $table->engine = "InnoDB";
    ...
    {
        Schema::dropIfExists('loyality_points_payements');
    }
}
